...
class FatTissue(TraitCard):
    ...
    def handler_start_feeding_phase(self):
        if self.owner_species_exists():  # Fixme: This is currently not returning false when no partnet.
            print(f' owner species exist = {self.owner_species_exists()}')
    ...
    def owner_species_exists(self) -> bool:
        ...
        """
        # print(self.owner_species)
        # print(self.owner_species())
        return self.owner_species is not None
                #self.owner_species() is not None)
